...
public class ResumeTestData {
    ...
    public static Resume fillResume() {
        Resume resume = new Resume("Селютин Павел Сергеевич");
        ...
        listPersonalData.add(new PersonalData(LocalDate.parse("2011-03-01"), LocalDate.parse("2013-03-01"), "Инженер-программист", "Реализация записи в базу данных MS SQL Server 2008 данных журналов контроллеров"));
        ...
        listPersonalData.add(new PersonalData(LocalDate.parse("2016-11-01"), LocalDate.parse("2016-11-20"), "ITIL", ""));
        listPersonalData.add(new PersonalData(LocalDate.parse("2006-11-01"), LocalDate.parse("2006-11-20"), "Программирование баз данных SQL Server 2000", ""));
        ...
        listPersonalData.add(new PersonalData(LocalDate.parse("2001-09-01"), LocalDate.parse("2006-07-31"), "Факультет Прикладная математика. Квалификация инженер-математик", ""));
